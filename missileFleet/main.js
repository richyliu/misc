...
Railgun = Klass(Weapon, {
    ...
    initAI: function() {
        ...
        compressionWave.append(new Circle(30, {
            x: 60
        }))
        var dur = 400
        ...
        smoke.append(new Rectangle(this.movementSpeed / 40, 2, {
            centered: true
        }))
...
Level4 = Klass(Level, {
    ...
    initialize: function() {
        Level.initialize.call(this)
        this.when('started', function() {
            this.group(this.enemyTeam, 1, 1000, 180, [Beam, Missiles, Railgun],
                true
            )
            ...
            this.groupAfter(20000, this.playerTeam, 1, 200, 800, [Beam, PointDefenseGun])
        })
    }
...
Level5 = Klass(Level, {
    ...
    initialize: function() {
        Level.initialize.call(this)
        this.when('started', function() {
            this.groupAfter(3000, this.enemyTeam, 1, this.width * 0.9, this.height * 0.85, [RapidFireRailgun, RapidFireRailgun, RapidFireRailgun])
        ...
        this.when('started', function() {
            ...
            for (var i = 1; i <= 10; i++) {
                this.groupAfter(i * 3000, this.enemyTeam, 0,
                    Math.random() * this.width, this.height + 40, [Beam, Beam], true)
            }
        })
    }
...
Level8 = Klass(Level, {
    ...
    initialize: function() {
        ...
        this.when('started', function() {
            ...
            for (var i = 1; i <= 8; i++) {
                this.groupAfter(i * 3000, this.enemyTeam, 4, -100, Math.random() * this.height, [Missiles, Missiles], true)
            }
            this.groupAfter(9 * 3000, this.enemyTeam, 4,
                this.width * 0.5, this.height + 50, [Missiles, Missiles], true)
            this.groupAfter(10 * 3000, this.enemyTeam, 4,
                this.width * 0.5, -50, [Missiles, Missiles], true)
        })
    }
        ...
        this.when('started', function() {
            for (var i = 1; i <= 10; i++) {
                this.groupAfter(i * 3000 - 1500, this.playerTeam, 4,
                    this.width * 0.80, this.height * (0.1 + Math.random() * 0.8), [(i <= 6 ? RapidFireRailgun : PointDefenseGun)])
                this.groupAfter(i * 3000, this.enemyTeam, 4,
                    this.width * 0.20, this.height * Math.random(), [RapidFireRailgun])
            }
        })
    }
    ...
    initialize: function() {
        ...
        this.when('started', function() {
            this.group(this.playerTeam, 5,
                this.width * 0.5, this.height * 0.5, [RapidFireRailgun, RapidFireRailgun, RapidFireRailgun])
            for (var i = 1; i <= 3; i++) {
                this.groupAfter(i * 3000, this.enemyTeam, 2,
                    this.width * Math.random(), this.height * Math.random(), [Railgun, PointDefenseMissiles, PointDefenseMissiles])
            }
            for (var i = 5; i <= 7; i++) {
                this.groupAfter(i * 3000, this.enemyTeam, 2,
                    this.width * Math.random(), this.height * Math.random(), [Beam, PointDefenseMissiles, PointDefenseMissiles])
            }
            for (var i = 9; i <= 12; i++) {
                this.groupAfter(i * 3000, this.enemyTeam, 4,
                    this.width * Math.random(), this.height * Math.random(), [Missiles, PointDefenseMissiles, PointDefenseMissiles])
            }
            this.groupAfter(15 * 3000, this.enemyTeam, 5,
                this.width * Math.random(), this.height * Math.random(), [Missiles, Missiles, Missiles, Missiles,
                    Missiles, Missiles, Missiles
                ])
        })
    }
